...
namespace GeometryShaderGrass
{
    [CustomEditor(typeof(GSG_AreaPainter))]
    [CanEditMultipleObjects]
    public class AreaPainterEditor : Editor
    {
        GSG_AreaPainter painter;
        ...
        void OnEnable()
        {
            painter = target as GSG_AreaPainter;
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (var verticalScope = new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                EditorGUILayout.IntSlider(amount, 1, /*60000*/1000000);
                GUI.enabled = true;
