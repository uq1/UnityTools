...
public class AdjustLightmaps : MonoBehaviour {
    [MenuItem ("Window/Unique Tools/Adjust Lightmap Scale - Mobile")]
    static void generateLow () {
        generateLightmapScale (15f);
    }

    [MenuItem ("Window/Unique Tools/Adjust Lightmap Scale - Desktop and Consoles")]
    static void generateMedium () {
        generateLightmapScale (10f);
    }

    [MenuItem ("Window/Unique Tools/Adjust Lightmap Scale - Film and TV Rendering")]
